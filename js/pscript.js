...
jQuery(document).ready(function() {
	...
	if ( jQuery.cookie('tm_panel_open') == 1 ) { 
		jQuery('#tm-control-panel').css({left: -250});
		jQuery('#tm-panel-switch').addClass('panel-open');
	}
	...
	jQuery('#tm-panel-bkgcolor').change(function(){
		var hex = this.value;	
	...
	jQuery('#tm-control-panel a.tm-panel-item').click(function(){
		...
		jQuery('body').css('backgroundImage', 'url(' + tm_theme_path + '/css/images/' + tm_texture_value + '.png)' );
	...
	jQuery('#tm-panel-body-font-color').change(function(){
		var hex = this.value;	
	...
	jQuery('#tm-panel-header-font-color').change(function(){
		var hex = this.value;	
	...
	//=================== NAVIGATION SETTINGS ========================//
	var tm_navfont_tag = '#site-navigation ul > li > a';
	...
	jQuery('#tm-panel-nav-font-color').change(function(){
		var hex = this.value;	
	...
	jQuery('#tm-panel-linkcolor').change(function(){
		var hex = this.value;	
	...
	jQuery('#tm-panel-footercolor').change(function(){
		var hex = this.value;	
